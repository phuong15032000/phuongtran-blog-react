...
class Register extends Component {
    ...
    handleCreate(e) {
        e.preventDefault();
        console.log(this.state.post.tagList)
        this.setState({
            message: "",
            successful: false
        });
        let demo = 0;
        for (let i of this.state.post.tempTags) {
            this.state.post.tagList.push({
                name: this.state.post.tempTags[demo]
            });
            demo = demo + 1;
        }
        ...
        if (this.checkBtn.context._errors.length === 0) {
            BlogDataService.createPost(
                ...
                response => {
                    ...
                    document.getElementById("id-input-tags").value="";
    ...
    onChangeTagList(e) {
        ...
        this.state.post.tempTags = temp;
        console.log(this.state.post.tempTags);
    }
    onChangeTitle(e) {
                ...
                <div className="templatemo-container">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 black-bg left-container">
                        ...
                        <ul className="nav nav-stacked templatemo-nav">
                                ...
                                <li><a href="/createpost"  className="active"><i className="fa fa-pencil" />Write blog</a></li>
                        ...
                        <div className="tm-right-inner-container">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    >
                                        <fieldset>
                                            <legend className="text-center">Write blog<span className="req" />
                                            </legend>
                                            ...
                                            <div className="form-group">
                                                <label><span className="req">* </span> Tags: (split by ",". Example: <input value="Covid-19,Dance,Vietnam" disable /> )</label>
                                                <input
                                                id="id-input-tags"
                                                    type="text"
                                                    className="form-control"
                                            ...
                                            <div className="form-group">
                                                ...
                                                id="id-input-img"
                                                    ...
                                                    type="text"
                                                    className="form-control"
                                                    value={this.state.post.img_thump_url}
